...
--  See `:help hlsearch`
vim.keymap.set('n', '<Enter>', '<cmd>nohlsearch<CR>')
...
vim.keymap.set('n', '<leader>pr', function()
  ...
  vim.cmd('Oil ' .. cwd)
end, { silent = true, desc = 'Open Oil with the original working directory' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sg', builtin.live_grep, { desc = '[S]earch by [G]rep' }) -- basicaly cmd-f
            ...
            plugins = {
              {
                ...
                location = '/Users/namhai/.nvm/versions/node/v22.2.0/lib/node_modules/@vue/language-server',
                languages = { 'vue' },
              },
            },
          },
  ...
  --       },
  --     }
  --     -- Auto-enable Zen Mode when Neovim starts
